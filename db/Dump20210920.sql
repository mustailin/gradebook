...
INSERT INTO `department` VALUES (1,1,'Computer Science'),(3,2,'Computer Engineering');
...
INSERT INTO `faculty` VALUES (1,'Інститут прикладного системного аналізу'),(2,'Інформатики та обчислювальної техніки');
...
CREATE TABLE `gradebook` (
  ...
  CONSTRAINT `fk_gradebook_group1` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`),
  CONSTRAINT `fk_gradebook_semester1` FOREIGN KEY (`semester_id`) REFERENCES `semester` (`id`)
...
CREATE TABLE `group` (
  ...
  CONSTRAINT `fk_academic_group_faculty1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`id`)
...
INSERT INTO `group` VALUES (1,'IT-ZP91',1),(2,'IT-ZP92',1),(3,'IT-ZP93',1),(4,'IT-IO23',2),(5,'IT-IO24',2),(8,'IT-ZP96',2);
...
INSERT INTO `lecturer` VALUES (1,1,'Ailin','Mustafayeva','mustailin@gmail.com','lecturer'),(2,1,'Liaman','Kazimova','liaman.kazymova@gmail.com','lecturer');
/*!40000 ALTER TABLE `lecturer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `lecturer_gradebooks`
--
...
CREATE TABLE `lecturer_has_gradebook` (
  `gradebook_id` int unsigned NOT NULL,
  ...
  CONSTRAINT `fk_course_lecturer_gradebook1` FOREIGN KEY (`gradebook_id`) REFERENCES `gradebook` (`id`),
...
INSERT INTO `lecturer_has_gradebook` VALUES (1,1),(1,2),(2,1),(2,2),(9,1),(9,2),(16,1);
...
INSERT INTO `semester` VALUES (1,'Spring',2020),(2,'Fall',2020),(3,'Spring',2021),(4,'Fall',2021),(5,'Spring',2016),(6,'Fall',2016),(7,'Spring',2017),(8,'Fall',2017),(9,'Spring',2018),(10,'Fall',2018),(11,'Spring',2019),(12,'Fall',2019),(15,'Spring',2023);
...
CREATE TABLE `student_attendance` (
  ...
  CONSTRAINT `fk_student_attendance_task1` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=464 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_attendance` VALUES (1,1,1,'2021-08-29',0,0,1),(2,1,1,'2021-08-01',1,0,0),(3,1,1,'2021-08-06',0,0,0),(4,1,1,'2021-08-08',0,0,0),(5,1,1,'2021-08-13',0,0,0),(6,1,1,'2021-08-15',0,0,0),(7,2,1,'2021-08-29',0,1,0),(8,2,1,'2021-08-01',0,1,0),(9,2,1,'2021-08-06',0,0,0),(10,2,1,'2021-08-08',0,0,0),(11,2,1,'2021-08-13',0,0,0),(12,2,1,'2021-08-15',0,0,0),(13,3,1,'2021-08-29',1,0,0),(14,3,1,'2021-08-01',0,0,1),(15,3,1,'2021-08-05',0,0,1),(16,3,1,'2021-08-08',0,0,0),(17,3,1,'2021-08-13',0,0,0),(18,3,1,'2021-08-15',0,0,0),(19,4,1,'2021-08-29',1,0,0),(20,4,1,'2021-08-01',1,0,0),(21,4,1,'2021-08-06',0,0,0),(22,4,1,'2021-08-08',0,0,0),(23,4,1,'2021-08-13',0,0,0),(24,4,1,'2021-08-15',0,0,0),(25,5,1,'2021-08-29',0,0,1),(26,5,1,'2021-08-01',0,0,0),(27,5,1,'2021-08-06',0,0,0),(28,5,1,'2021-08-08',0,0,0),(29,5,1,'2021-08-13',0,0,0),(30,5,1,'2021-08-15',0,0,0),(31,6,1,'2021-08-29',1,0,0),(32,6,1,'2021-08-01',0,0,1),(33,6,1,'2021-08-06',0,0,0),(34,6,1,'2021-08-08',0,0,0),(35,6,1,'2021-08-13',0,0,0),(36,6,1,'2021-08-15',0,0,0),(37,7,1,'2021-08-29',1,0,0),(38,7,1,'2021-08-01',1,0,0),(39,7,1,'2021-08-06',1,0,0),(40,7,1,'2021-08-08',0,0,0),(41,7,1,'2021-08-13',0,0,0),(42,7,1,'2021-08-15',0,0,0),(43,8,1,'2021-08-29',1,0,0),(44,8,1,'2021-08-01',0,0,0),(45,8,1,'2021-08-06',0,0,0),(46,8,1,'2021-08-08',0,0,0),(47,8,1,'2021-08-13',0,0,0),(48,8,1,'2021-08-15',0,0,0),(49,9,1,'2021-08-29',1,0,0),(50,9,1,'2021-08-01',1,0,0),(51,9,1,'2021-08-06',0,0,0),(52,9,1,'2021-08-08',0,0,0),(53,9,1,'2021-08-13',0,0,0),(54,9,1,'2021-08-15',0,0,0),(55,10,1,'2021-08-29',1,0,0),(56,10,1,'2021-08-01',1,0,0),(57,10,1,'2021-08-06',0,0,0),(58,10,1,'2021-08-08',0,0,0),(59,10,1,'2021-08-13',0,0,0),(60,10,1,'2021-08-15',0,0,0),(61,1,2,'2021-08-20',0,0,0),(62,1,2,'2021-08-22',0,0,0),(63,1,2,'2021-08-27',0,0,0),(64,1,2,'2021-08-29',0,0,0),(65,2,2,'2021-08-20',0,0,0),(66,2,2,'2021-08-22',0,0,0),(67,2,2,'2021-08-27',0,0,0),(68,2,2,'2021-08-29',0,0,0),(69,3,2,'2021-08-20',0,0,0),(70,3,2,'2021-08-22',0,0,0),(71,3,2,'2021-08-27',0,0,0),(72,3,2,'2021-08-29',0,0,0),(73,4,2,'2021-08-20',0,0,0),(74,4,2,'2021-08-22',0,0,0),(75,4,2,'2021-08-27',0,0,0),(76,4,2,'2021-08-29',0,0,0),(77,5,2,'2021-08-20',0,0,0),(78,5,2,'2021-08-22',0,0,0),(79,5,2,'2021-08-27',0,0,0),(80,5,2,'2021-08-29',0,0,0),(81,6,2,'2021-08-20',0,0,0),(82,6,2,'2021-08-22',0,0,0),(83,6,2,'2021-08-27',0,0,0),(84,6,2,'2021-08-29',0,0,0),(85,7,2,'2021-08-20',0,0,0),(86,7,2,'2021-08-22',0,0,0),(87,7,2,'2021-08-27',0,0,0),(88,7,2,'2021-08-29',0,0,0),(89,8,2,'2021-08-20',0,0,0),(90,8,2,'2021-08-22',0,0,0),(91,8,2,'2021-08-27',0,0,0),(92,8,2,'2021-08-29',0,0,0),(93,9,2,'2021-08-20',0,0,0),(94,9,2,'2021-08-22',0,0,0),(95,9,2,'2021-08-27',0,0,0),(96,9,2,'2021-08-29',0,0,0),(97,10,2,'2021-08-20',0,0,0),(98,10,2,'2021-08-22',0,0,0),(99,10,2,'2021-08-27',0,0,0),(100,10,2,'2021-08-29',0,0,0),(101,11,3,'2020-09-01',0,0,0),(102,11,3,'2020-09-03',0,0,0),(103
),(353,3,9,'2018-07-23',0,0,0),(354,3,9,'2018-07-30',0,0,0),(355,3,9,'2018-07-11',0,0,0),(356,3,9,'2018-07-18',0,0,0),(357,3,9,'2018-07-25',0,0,0),(358,3,9,'2018-08-01',0,0,0),(359,3,9,'2018-07-13',0,0,0),(360,3,9,'2018-07-20',0,0,0),(361,3,9,'2018-07-27',0,0,0),(362,3,9,'2018-08-03',0,0,0),(363,9,9,'2018-07-08',0,1,0),(364,9,9,'2018-07-16',0,0,0),(365,9,9,'2018-07-23',0,0,0),(366,9,9,'2018-07-30',0,0,0),(367,9,9,'2018-07-11',0,0,0),(368,9,9,'2018-07-18',0,0,0),(369,9,9,'2018-07-24',0,0,1),(370,9,9,'2018-08-01',0,0,0),(371,9,9,'2018-07-13',0,0,0),(372,9,9,'2018-07-20',0,0,0),(373,9,9,'2018-07-27',0,0,0),(374,9,9,'2018-08-03',0,0,0),(375,10,9,'2018-07-09',0,0,0),(376,10,9,'2018-07-16',0,0,0),(377,10,9,'2018-07-23',0,0,0),(378,10,9,'2018-07-30',0,0,0),(379,10,9,'2018-07-11',0,0,0),(380,10,9,'2018-07-18',0,0,0),(381,10,9,'2018-07-25',0,0,0),(382,10,9,'2018-08-01',0,0,0),(383,10,9,'2018-07-13',0,0,0),(384,10,9,'2018-07-20',0,0,0),(385,10,9,'2018-07-27',0,0,0),(386,10,9,'2018-08-03',0,0,0),(387,1,9,'2018-07-09',0,0,0),(388,1,9,'2018-07-15',1,0,0),(389,1,9,'2018-07-23',0,0,0),(390,1,9,'2018-07-30',0,0,0),(391,1,9,'2018-07-11',0,0,0),(392,1,9,'2018-07-18',0,0,0),(393,1,9,'2018-07-25',0,0,0),(394,1,9,'2018-08-01',0,0,0),(395,1,9,'2018-07-13',0,0,0),(396,1,9,'2018-07-20',0,0,0),(397,1,9,'2018-07-27',0,0,0),(398,1,9,'2018-08-03',0,0,0),(399,4,9,'2018-07-09',0,0,0),(400,4,9,'2018-07-16',0,0,0),(401,4,9,'2018-07-23',0,0,0),(402,4,9,'2018-07-30',0,0,0),(403,4,9,'2018-07-11',0,0,0),(404,4,9,'2018-07-18',0,0,0),(405,4,9,'2018-07-25',0,0,0),(406,4,9,'2018-08-01',0,0,0),(407,4,9,'2018-07-13',0,0,0),(408,4,9,'2018-07-20',0,0,0),(409,4,9,'2018-07-27',0,0,0),(410,4,9,'2018-08-03',0,0,0),(411,2,9,'2018-07-09',0,0,0),(412,2,9,'2018-07-16',0,0,0),(413,2,9,'2018-07-23',0,0,0),(414,2,9,'2018-07-30',0,0,0),(415,2,9,'2018-07-11',0,0,0),(416,2,9,'2018-07-18',0,0,0),(417,2,9,'2018-07-25',0,0,0),(418,2,9,'2018-08-01',0,0,0),(419,2,9,'2018-07-13',0,0,0),(420,2,9,'2018-07-20',0,0,0),(421,2,9,'2018-07-27',0,0,0),(422,2,9,'2018-08-03',0,0,0),(423,6,9,'2018-07-09',0,0,0),(424,6,9,'2018-07-16',0,0,0),(425,6,9,'2018-07-23',0,0,0),(426,6,9,'2018-07-30',0,0,0),(427,6,9,'2018-07-11',0,0,0),(428,6,9,'2018-07-18',0,0,0),(429,6,9,'2018-07-25',0,0,0),(430,6,9,'2018-08-01',0,0,0),(431,6,9,'2018-07-13',0,0,0),(432,6,9,'2018-07-20',0,0,0),(433,6,9,'2018-07-27',0,0,0),(434,6,9,'2018-08-03',0,0,0),(435,7,9,'2018-07-09',0,0,0),(436,7,9,'2018-07-16',0,0,0),(437,7,9,'2018-07-23',0,0,0),(438,7,9,'2018-07-30',0,0,0),(439,7,9,'2018-07-11',0,0,0),(440,7,9,'2018-07-18',0,0,0),(441,7,9,'2018-07-25',0,0,0),(442,7,9,'2018-08-01',0,0,0),(443,7,9,'2018-07-13',0,0,0),(444,7,9,'2018-07-20',0,0,0),(445,7,9,'2018-07-27',0,0,0),(446,7,9,'2018-08-03',1,0,0),(447,8,9,'2018-07-09',0,0,0),(448,8,9,'2018-07-16',0,0,0),(449,8,9,'2018-07-23',0,0,0),(450,8,9,'2018-07-30',0,0,0),(451,8,9,'2018-07-11',0,0,0),(452,8,9,'2018-07-18',0,0,0),(453,8,9,'2018-07-25',0,0,0),(454,8,9,'2018-08-01',0,0,0),(455,8,9,'2018-07-13',0,0,0),(456,8,9,'2018-07-20',0,0,0),(457,8,9,'2018-07-27',0,0,0),(458,8,9,'2018-08-03',0,0,0);
...
CREATE TABLE `student_grade` (
  ...
  CONSTRAINT `fk_student_grade_student1` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`),
  CONSTRAINT `fk_student_grade_task1` FOREIGN KEY (`task_id`) REFERENCES `task` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task` (
  ...
  `task_length` tinyint unsigned NOT NULL,
  ...
  CONSTRAINT `fk_task_gradebook1` FOREIGN KEY (`gradebook_id`) REFERENCES `gradebook` (`id`)
...
INSERT INTO `user` VALUES ('amber.heard@gmail.com',_binary '',_binary '',_binary '',_binary '','7AD539456FC3385E723D43952AEE127D38AEE522'),('bilbo.baggins@gmail.com',_binary '',_binary '',_binary '',_binary '','E76FD7133CFCE77304C5FF268B1AFF026A3B0174'),('john.doe@mail.com',_binary '',_binary '',_binary '',_binary '','7AD539456FC3385E723D43952AEE127D38AEE522'),('john.doe2@mail.com',_binary '',_binary '',_binary '',_binary '','7AD539456FC3385E723D43952AEE127D38AEE522'),('mustailin@gmail.com',_binary '',_binary '',_binary '',_binary '','7AD539456FC3385E723D43952AEE127D38AEE522'),('tony.montana@gmail.com',_binary '',_binary '',_binary '',_binary '','E76FD7133CFCE77304C5FF268B1AFF026A3B0174'),('woody.allen@gmail.com',_binary '',_binary '',_binary '',_binary '','7AD539456FC3385E723D43952AEE127D38AEE522');
...
INSERT INTO `user_roles` VALUES ('john.doe@mail.com','ROLE_USER, ROLE_ADMIN'),('john.doe2@mail.com','ROLE_USER'),('amber.heard@gmail.com','ROLE_USER'),('woody.allen@gmail.com','ROLE_USER, ROLE_ADMIN'),('mustailin@gmail.com','ROLE_USER');
...
-- Dump completed on 2021-09-20  2:38:58
